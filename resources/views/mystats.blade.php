        ...
        <div id="mystats" class="container">
            ...
            <div class="row">
                ...
                <div class="resetbutton" v-show="tracks.length > 0">
                    <button class="btn btn-primary" v-on:click="reset">Buscar de nuevo!</button>
                </div>
            </div>
